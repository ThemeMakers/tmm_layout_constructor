...
<?php foreach ($tmm_layout_constructor as $row => $row_data) : ?>
	...
	<?php if (!empty($row_data)): ?>
		...
		<div class="section-full-width<?php if (!empty($tmm_layout_constructor_row[$row]['bg_image'])): ?> parallax<?php endif; ?><?php echo (isset($row_data['front_css_class']) ? @$row_data['front_css_class'] : ''); ?><?php if (isset($tmm_layout_constructor_row[$row]['bg_type']) AND $tmm_layout_constructor_row[$row]['bg_type'] == 'default'): ?> theme-default-bg<?php endif; ?>" <?php if (isset($tmm_layout_constructor_row[$row]['bg_type']) AND $tmm_layout_constructor_row[$row]['bg_type'] == 'custom'){ ?><?php echo $row_style['style_custom_color']; ?><?php }else if(!empty($row_style['style_border'])){ ?>style="<?php echo $row_style['style_border']; ?>"<?php } ?>>
